...
public class Player {
	...
	/**
	 * @param dataPlaceNumber
	 *            the dataPlaceNumber to set
	 */
	...
	public String makeDBGetEntryString() {
		String ret = "DBGetEntryString successful " + this.getOnline() + "|"
				+ this.getLevel() + "|" + this.getTitleName() + "|"
				+ this.getFaceNumber() + "|" + "-1" + "|" + " "
				+ "db_addressbook" + " " + this.getCdkey() + "#"
				+ Tools.sixtyTwoScale(this.getRegNumber()) + " "
				+ this.getOnline() + " 0";
		return ret;
	}
